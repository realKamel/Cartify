...
public class CategoriesController(ICategoryServices services) : V1BaseController
{
    ...
    [HttpGet]
    [ProducesResponseType(typeof(PagedList<CategoryResponseDto>), StatusCodes.Status200OK)]
    ...
    [ProducesResponseType(StatusCodes.Status409Conflict)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    public async Task<ActionResult> UpdateCategoryAsync(int id, CreateOrUpdatedCategoryRequestDto requestDto,
        CancellationToken cancellationToken)
    {
